...
data class StageDTO(
    ...
    fun convertToMetrikBuildStage(): metrik.common.model.Stage? {
        ...
        val metrikStage = metrik.common.model.Stage(
            name,
